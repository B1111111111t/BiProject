...
/** AsyncGenChartByAi POST /api/chart/AsyncGen */
export async function asyncGenChartByAiUsingPost(
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/AsyncGen', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** GenChartByAiAsyncMq POST /api/chart/AsyncGen/mq */
export async function genChartByAiAsyncMqUsingPost(
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/AsyncGen/mq', {
    method: 'POST',
    params: {
      ...params,
    },
